    ...
    <div style={{ maxWidth:'1920px',  backgroundColor:'white' }}> 
      ...
      <div className='row'>
        <div className='col-12'>
          <p className='title-route'>Home - CHWs / Promotores - Personal and Professional Development - Conflict Resolution</p>
            <div className='col-6'>
              <h1 className='title-h1-subpages' style={{ paddingTop: '35px'}}>Conflict Resolution</h1>
...
Assessment Digital" subtitle="Conflict Resolution" text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean lacus neque, fermentum nec..."/>
          ...
          <div className="col-sm-4">
            <TopicsCard  img={'/mg-2/AgenciesCard.png'} title="A211D - Self-Awareness
Assessment Printable" subtitle="Conflict Resolution" text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean lacus neque, fermentum nec..."/>
          </div>
        </div>
      </div>
    </div>
