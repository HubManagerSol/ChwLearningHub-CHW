    ...
    <div style={{ maxWidth:'1920px',  backgroundColor:'white' }}> 
      ...
      <div className='row'>
        <div className='col-12'>
          <p className='title-route'>Home - CHWs / Promotores - Personal and Professional Development - Community Outreach & Safety</p>
            <div className='col-6'>
              <h1 className='title-h1-subpages' style={{ paddingTop: '35px'}}>Community Outreach & Safety</h1>
...
{/* ---------------------------------------PONER CARD OVERVIEW */}
        ...
        <div className="row">
          <div className="col-sm-4">
            <TopicsCard  img={'/mg-2/AgenciesCard.png'}  title="2102 - Community outreach guidelines" subtitle="CommRoles & Core Competencies C3unication" text="Community Health Workers (CHWs) are trusted members of the communities where they live..."/>
          </div>
...
export default CommunityOutreachSafety;
