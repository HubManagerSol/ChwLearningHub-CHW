    ...
    <div style={{ maxWidth:'1920px',  backgroundColor:'white' }}> 
      ...
      <div className='row'>
        <div className='col-12'>
          <p className='title-route'>Home - CHWs / Promotores - Personal and Professional Development - Stress Management</p>
            <div className='col-6'>
              <h1 className='title-h1-subpages' style={{ paddingTop: '35px'}}>Stress Management</h1>
