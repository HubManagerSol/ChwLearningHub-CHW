...
import CalendarNextEvent5 from "../../../mg-2/CalendarNextEvent5.png"
      ...
      <div className='row'>
        <div className='col-12'>
          <p className='title-route'>
            ...
            <div className='col-6'>
              <h1 className='title-h1-subpages' style={{ paddingTop: '35px'}}>Communication</h1>
        ...
        <ReadCard 
          img={CalendarNextEvent5} 
          title={'2111 - What is communication?'}
        ...
        <div className="row">
          <div className="col-sm-4">
            <TopicsCard  img={'/mg-2/AgenciesCard.png'}  title="2114 -  Tips to improve your
communication skills" subtitle="Communication" text="Community Health Workers (CHWs) are trusted members of the communities where they live..."/>
          </div>
          <div className="col-sm-4">
            <TopicsCard  img={'/mg-2/AgenciesCard.png'} className="mx-4" title="2112 - 10 common communication
oversights"  subtitle="Communication" text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean lacus neque, fermentum nec..."/>
          </div>
          <div className="col-sm-4">
