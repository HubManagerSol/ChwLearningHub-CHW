...
<div className='row' style={{width:'1200px', background: '#F4F4F4', marginTop: '40px', padding: '35px 35px 35px 35px', borderRadius: '10px', fontSize: '20px', alignItems: 'flex-start', gap: '30px'}}>
...
<div className='row'>
    <p style={{color: '#067CBC', fontSize: '23px'}}>
...
<div class="row">
                <h1 className='title-h1-overview' >Community transformation model</h1>
</div>
<div>
    <div className='row'>
        <div className='col-6'>
            <div class="row">
                <p className='p-overview'>The community transformation model helps us to visualize how CHWs through their different roles and capacities, promote and motivate positive changes in the life of individuals, families, and communities.
This transformation happens when:
</p>
<p className='p-overview'>
1 - Strong and meaningful relationships are built through community outreach, peer support, one-on-one meetings, solidarity, and constant partnership.
 <br></br>
 <br></br>
2 - Individual and collective capacity building is supported through educational workshops, informational materials, resources, and mutual exchange of experiences and knowledge.
<br></br>
<br></br>
3 - Community engagement is promoted through awareness, individual, and collective leadership development that leads us to advocacy and action. 
<br></br>
<br></br>
</p>
            </div>
...
<div class="row" style={{paddingBottom: '10px'}}>
                <h1  className='title-h1-overview'style={{ paddingTop: '40px', fontWeight: 'bold'}}>Names and roles that CHWs have had around the world </h1>
</div>
<div className='row'>
    <p>
...
<div className='row'>
<img src="../mg-2/timeline.png" alt="img" style={{ width: '1198', height: '627', alignContent: 'center' }}/>
</div>
<div class="row">
    <h1 className='title-h1-overview' style={{ paddingTop: '40px', fontWeight: 'bold', paddingBottom: '20px'}}>Skills of CHWs</h1>
</div>
...
<div className='row'>
<img src="../mg-2/paulofreire.png" alt="img" style={{ width: '1196', height: '528px', alignContent: 'center' }}/>
</div>
<div class="row">
